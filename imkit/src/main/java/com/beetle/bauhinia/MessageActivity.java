...
import static com.beetle.bauhinia.constant.RequestCodes.SELECT_PICTURE;
import static com.beetle.bauhinia.constant.RequestCodes.SELECT_PICTURE_KITKAT;
import static com.beetle.bauhinia.constant.RequestCodes.TAKE_PICTURE;
...
public class MessageActivity extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG, "onCreate: getConnectState " + IMService.getInstance().getConnectState());
    ...
    protected void sendMessageContent(IMessage.MessageContent content) {
        //TODO
        Log.i(TAG, "not implemented");
        IMMessage iMessage = new IMMessage();
        iMessage.sender = 1000005;
        iMessage.receiver = 1000003;
        iMessage.content = content.getRaw();
        IMService.getInstance().sendPeerMessage(iMessage);
    }
